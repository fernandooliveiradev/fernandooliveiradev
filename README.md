<h1 align="center">Fernando de Oliveira</h1>

<p align="center">
  Desenvolvedor Web com foco em IA Generativa, automações e soluções digitais.
</p>
...
- Graduação em Inteligência Artificial pela UNISUL
- Machine Learning e fundamentos de IA
- Python, Django e APIs
- React, JavaScript, HTML e CSS
- SQL Server e PostgreSQL
- Git, GitHub, CI/CD e GitHub Actions
- AWS, Docker e deploy de aplicações
- Clean Code, SOLID e Design Patterns
- Cybersecurity e ética em IA
- Scrum e Kanban
...
Tenho trajetória em desenvolvimento web, suporte técnico, ambientes WordPress/WooCommerce, criação de sites, lojas virtuais, integrações, automações e evolução de produtos digitais.

Nos últimos projetos, venho atuando com soluções envolvendo IA Generativa, ferramentas de apoio ao desenvolvimento, fluxos automatizados, documentação de requisitos, testes de MVPs e apoio técnico a clientes e times internos.
...
<p align="center">
  Construindo soluções digitais com IA, automação e desenvolvimento web.
</p>
